...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  //Note: Not rendering properly -- getting a deprecation error 
  // 'Event.path is deprecated and will be removed. Please use Event.composedPath() instead.
  // Affected resources: leaflet.js:5
  // tried to create a legend in HTML/CSS but not much luck
  ...
  // add tectonicPlates to map layer
